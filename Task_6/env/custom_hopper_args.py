...
class CustomHopper(MujocoEnv, utils.EzPickle):
    ...
    def sample_parameters(self):
        ...
        mass_ranges = {
            'thigh': (self.original_masses[0] * (1 - self.thigh_range), self.original_masses[0] * (1 + self.thigh_range)),
            'leg': (self.original_masses[1] * (1 - self.leg_range), self.original_masses[1] * (1 + self.leg_range)),
            'foot': (self.original_masses[2] * (1 - self.foot_range), self.original_masses[2] * (1 + self.foot_range))
        }
