...
def main():
    ...
    with open('/home/ale/TT_RLProject_2024/Task_3/A2C_Entr_LowerAlive_Logs.csv', 'w', newline='') as csvfile:
    ...
    for episode in range(args.n_episodes):
        ...
        with open('/home/ale/TT_RLProject_2024/Task_3/A2C_Entr_LowerAlive_Logs.csv', 'a', newline='') as csvfile:
            csvwriter = csv.writer(csvfile)
    ...
    torch.save(agent.actor.state_dict(), "/home/ale/TT_RLProject_2024/Task_3/A2C_Entr_LowerAlive.mdl")
