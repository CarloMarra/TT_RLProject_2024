...
def main():
    ...
    model = PPO("MlpPolicy", batch_size = 256, learning_rate=0.001, gamma=0.99, ent_coef=0.01, n_steps=4096, env=env, verbose=1)


    # Continue Training for another 250_000 timesteps
    model.learn(total_timesteps=int(500_000), progress_bar=True)
    model.save("/home/ale/TT_RLProject_2024/Task_5/FinalModels/target_final")
